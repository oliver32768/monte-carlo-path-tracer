...
public:
    ...
    void set_face_normal(const ray& r, const vec3& outward_normal)
    {
        ...
        front_face = dot(r.direction(), outward_normal) < 0; // < 0 means pointing in opposite directions
        normal = front_face ? outward_normal : -outward_normal; // Every surface has two normals (front and back)
    }
};
